...
$con=mysqli_connect('localhost','root','','project');
 ...
 /*e PHPMailer\PHPMailer\PHPMailer;
...
$insert="insert into addadv (batch,name,email,phone)values ('$batch','$name','$email','$phone')";
...
$insert2="insert into login values ('$uid','$password','advisor')";
$ins2=mysqli_query($con,$insert2);
if($ins2)  
   {  
      echo'<script>alert("advisor login ")</script>';    
   }  
else  
   {  
      echo'<script>alert("advisorlogin failed!!")</script>';  
   }  
  //echo $password;
