 <?php 
    ...
    $query = " select * from addadv where id='".$id."'";
...
<center><h2><b>UPDATE ADVISOR DETAILS</b></h2>
<form name="form1" method="post" action="" >
<div class="input-group"><table  width=50%>
        <tr><td>
<label>Batch:</label></td><td>
<input type="text" ame="batch" value="<?php echo $batch ?>">
</div>
...
$phone=$_POST['phone'];
        ...
        $query = "update addadv set  batch = '$batch',name = '$name', email='$email',phone='$phone'  where batch='$batch' ";
        $result = mysqli_query($con,$query);
