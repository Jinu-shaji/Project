...
$select="select *from work where type like 'seminar'";
$selresult=mysqli_query($con,$select);
$select1="select *from upworksem ";
...
<li><a href="home.html">LOGOUT!</a>
  ...
  <center><h1>MARKS(SEMINAR)</h1><br><br><br><br><br>
  <table >
<thead  >
<tr >
<th>WORK</th>
...
?>
 <td><?php
 $s2="select mark from upworksem where id='$id'";
